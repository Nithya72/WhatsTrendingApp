...
#endif
#ifdef GENERATOR_FILE
extern const char *darwin_target_linker;
#else
  const char *x_darwin_target_linker;
#define darwin_target_linker global_options.x_darwin_target_linker
#endif
#ifdef GENERATOR_FILE
...
#define MASK_MACHO_DYNAMIC_NO_PIC (1U << 9)
...
enum opt_code
{
  ...
  /* OPT_Wmudflap = 292, */                  /* -Wmudflap */
  OPT_Wmultichar = 293,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 294,           /* -Wmultiple-inheritance */
  OPT_Wnamespaces = 295,                     /* -Wnamespaces */
  OPT_Wnarrowing = 296,                      /* -Wnarrowing */
  OPT_Wnested_externs = 297,                 /* -Wnested-externs */
  OPT_Wnoexcept = 298,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 299,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 300,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 301,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 302,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 303,                /* -Wnonnull-compare */
  OPT_Wnonportable_cfstrings = 304,          /* -Wnonportable-cfstrings */
  ...
  OPT_Z = 443,                               /* -Z */
  OPT_Zall_load = 444,                       /* -Zall_load */
  OPT_Zallowable_client = 445,               /* -Zallowable_client */
  OPT_Zarch_errors_fatal = 446,              /* -Zarch_errors_fatal */
  OPT_Zbind_at_load = 447,                   /* -Zbind_at_load */
  OPT_Zbundle = 448,                         /* -Zbundle */
  OPT_Zbundle_loader = 449,                  /* -Zbundle_loader */
  OPT_Zdead_strip = 450,                     /* -Zdead_strip */
  OPT_Zdylib_file = 451,                     /* -Zdylib_file */
  OPT_Zdynamic = 452,                        /* -Zdynamic */
  OPT_Zdynamiclib = 453,                     /* -Zdynamiclib */
  OPT_Zexported_symbols_list = 454,          /* -Zexported_symbols_list */
  OPT_Zflat_namespace = 455,                 /* -Zflat_namespace */
  OPT_Zfn_seg_addr_table_filename = 456,     /* -Zfn_seg_addr_table_filename */
  OPT_Zforce_cpusubtype_ALL = 457,           /* -Zforce_cpusubtype_ALL */
  OPT_Zforce_flat_namespace = 458,           /* -Zforce_flat_namespace */
  OPT_Zimage_base = 459,                     /* -Zimage_base */
  OPT_Zinit = 460,                           /* -Zinit */
  OPT_Zinstall_name = 461,                   /* -Zinstall_name */
  OPT_Zmulti_module = 462,                   /* -Zmulti_module */
  OPT_Zmultiply_defined = 463,               /* -Zmultiply_defined */
  OPT_Zmultiplydefinedunused = 464,          /* -Zmultiplydefinedunused */
  OPT_Zno_dead_strip_inits_and_terms = 465,  /* -Zno_dead_strip_inits_and_terms */
  OPT_Zseg_addr_table = 466,                 /* -Zseg_addr_table */
  OPT_Zsegaddr = 467,                        /* -Zsegaddr */
  OPT_Zsegs_read_only_addr = 468,            /* -Zsegs_read_only_addr */
  OPT_Zsegs_read_write_addr = 469,           /* -Zsegs_read_write_addr */
  OPT_Zsingle_module = 470,                  /* -Zsingle_module */
  OPT_Zumbrella = 471,                       /* -Zumbrella */
  OPT_Zunexported_symbols_list = 472,        /* -Zunexported_symbols_list */
  OPT_Zweak_reference_mismatches = 473,      /* -Zweak_reference_mismatches */
  /* OPT_all_load = 474, */                  /* -all_load */
  /* OPT_allowable_client = 475, */          /* -allowable_client */
  OPT_ansi = 476,                            /* -ansi */
  OPT_arch = 477,                            /* -arch */
  /* OPT_arch_errors_fatal = 478, */         /* -arch_errors_fatal */
  OPT_asm_macosx_version_min_ = 479,         /* -asm_macosx_version_min= */
  OPT_aux_info = 480,                        /* -aux-info */
  /* OPT_aux_info_ = 481, */                 /* -aux-info= */
  OPT_auxbase = 482,                         /* -auxbase */
  OPT_auxbase_strip = 483,                   /* -auxbase-strip */
  /* OPT_bind_at_load = 484, */              /* -bind_at_load */
  /* OPT_bundle = 485, */                    /* -bundle */
  /* OPT_bundle_loader = 486, */             /* -bundle_loader */
  OPT_c = 487,                               /* -c */
  OPT_client_name = 488,                     /* -client_name */
  OPT_compatibility_version = 489,           /* -compatibility_version */
  OPT_coverage = 490,                        /* -coverage */
  OPT_cpp = 491,                             /* -cpp */
  OPT_cpp_ = 492,                            /* -cpp= */
  OPT_current_version = 493,                 /* -current_version */
  OPT_d = 494,                               /* -d */
  /* OPT_dead_strip = 495, */                /* -dead_strip */
  /* OPT_dependency_file = 496, */           /* -dependency-file */
  ...
  /* OPT_dylib_file = 503, */                /* -dylib_file */
  OPT_dylinker = 504,                        /* -dylinker */
  OPT_dylinker_install_name = 505,           /* -dylinker_install_name */
  /* OPT_dynamic = 506, */                   /* -dynamic */
  /* OPT_dynamiclib = 507, */                /* -dynamiclib */
  OPT_e = 508,                               /* -e */
  OPT_export_dynamic = 509,                  /* -export-dynamic */
  /* OPT_exported_symbols_list = 510, */     /* -exported_symbols_list */
  OPT_fPIC = 511,                            /* -fPIC */
  OPT_fPIE = 512,                            /* -fPIE */
  OPT_fRTS_ = 513,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 514,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 515,                   /* -fabi-version= */
  OPT_faccess_control = 516,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 517,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 518,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 519,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 520,                  /* -falign-commons */
  OPT_falign_functions = 521,                /* -falign-functions */
  OPT_falign_functions_ = 522,               /* -falign-functions= */
  OPT_falign_jumps = 523,                    /* -falign-jumps */
  OPT_falign_jumps_ = 524,                   /* -falign-jumps= */
  OPT_falign_labels = 525,                   /* -falign-labels */
  OPT_falign_labels_ = 526,                  /* -falign-labels= */
  OPT_falign_loops = 527,                    /* -falign-loops */
  OPT_falign_loops_ = 528,                   /* -falign-loops= */
  /* OPT_faligned_new = 529, */              /* -faligned-new */
  OPT_faligned_new_ = 530,                   /* -faligned-new= */
  OPT_fall_intrinsics = 531,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 532, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 533,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 534,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 535, */   /* -falt-external-templates */
  OPT_fapple_kext = 536,                     /* -fapple-kext */
  /* OPT_fargument_alias = 537, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 538, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 539, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 540, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 541,            /* -fasan-shadow-offset= */
  OPT_fasm = 542,                            /* -fasm */
  OPT_fassociative_math = 543,               /* -fassociative-math */
  ...
  OPT_fbranch_count_reg = 553,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 554,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 555,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 556,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 557,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 558,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 559,                        /* -fbuiltin */
  OPT_fbuiltin_ = 560,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 561,                 /* -fbuiltin-printf */
  ...
  OPT_fcheck_array_temporaries = 566,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 567,                /* -fcheck-data-deps */
  OPT_fcheck_new = 568,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 569,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 570,                         /* -fcheck= */
  OPT_fchecking = 571,                       /* -fchecking */
  OPT_fchecking_ = 572,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 573,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 574,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 575,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 576,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 577,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 578,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 579,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 580,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 581, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 582,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 583,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 584,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 585, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 586,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 587,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 588,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 589,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 590,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 591,                       /* -fcilkplus */
  OPT_fcoarray_ = 592,                       /* -fcoarray= */
  OPT_fcode_hoisting = 593,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 594,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 595,                         /* -fcommon */
  OPT_fcompare_debug = 596,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 597,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 598,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 599,                   /* -fcompare-elim */
  OPT_fconcepts = 600,                       /* -fconcepts */
  OPT_fcond_mismatch = 601,                  /* -fcond-mismatch */
  OPT_fconserve_space = 602,                 /* -fconserve-space */
  OPT_fconserve_stack = 603,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 604,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 605,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 606,          /* -fconstexpr-loop-limit= */
  OPT_fconvert_ = 607,                       /* -fconvert= */
  OPT_fcprop_registers = 608,                /* -fcprop-registers */
  OPT_fcray_pointer = 609,                   /* -fcray-pointer */
  OPT_fcrossjumping = 610,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 611,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 612, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 613,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 614,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 615,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 616,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 617,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 618,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 619,                       /* -fdbg-cnt= */
  OPT_fdce = 620,                            /* -fdce */
  OPT_fdebug_cpp = 621,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 622,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 623,            /* -fdebug-types-section */
  OPT_fdec = 624,                            /* -fdec */
  OPT_fdec_intrinsic_ints = 625,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 626,                       /* -fdec-math */
  OPT_fdec_static = 627,                     /* -fdec-static */
  OPT_fdec_structure = 628,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 629,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 630,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 631,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 632, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 633,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 634,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 635,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 636,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 637,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 638,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 639,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 640,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 641,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 642, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 643,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_generate_patch = 644,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_parseable_fixits = 645,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 646,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 647,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 648,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 649,                /* -fdirectives-only */
  OPT_fdisable_ = 650,                       /* -fdisable- */
  OPT_fdollar_ok = 651,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 652,         /* -fdollars-in-identifiers */
  OPT_fdse = 653,                            /* -fdse */
  OPT_fdump_ = 654,                          /* -fdump- */
  OPT_fdump_ada_spec = 655,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 656,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 657, */                /* -fdump-core */
  OPT_fdump_final_insns = 658,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 659,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 660,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 661,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 662,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 663,        /* -fdump-internal-locations */
  ...
  OPT_femit_struct_debug_baseonly = 676,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 677,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 678,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 679,                        /* -fenable- */
  OPT_fenforce_eh_specs = 680,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 681, */           /* -fenum-int-equiv */
  OPT_fexceptions = 682,                     /* -fexceptions */
  OPT_fexcess_precision_ = 683,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 684,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 685,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 686,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 687,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 688,                /* -fextern-tls-init */
  OPT_fexternal_blas = 689,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 690, */       /* -fexternal-templates */
  OPT_ff2c = 691,                            /* -ff2c */
  OPT_ffast_math = 692,                      /* -ffast-math */
  OPT_ffat_lto_objects = 693,                /* -ffat-lto-objects */
  OPT_ffinite_math_only = 694,               /* -ffinite-math-only */
  OPT_ffixed_ = 695,                         /* -ffixed- */
  OPT_ffixed_form = 696,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 697,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 698,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 699,                    /* -ffloat-store */
  OPT_ffor_scope = 700,                      /* -ffor-scope */
  /* OPT_fforce_addr = 701, */               /* -fforce-addr */
  OPT_fforward_propagate = 702,              /* -fforward-propagate */
  OPT_ffp_contract_ = 703,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 704,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 705,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 706,                      /* -ffpe-trap= */
  OPT_ffree_form = 707,                      /* -ffree-form */
  OPT_ffree_line_length_ = 708,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 709,          /* -ffree-line-length-none */
  OPT_ffreestanding = 710,                   /* -ffreestanding */
  OPT_ffriend_injection = 711,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 712,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 713,                   /* -ffunction-cse */
  OPT_ffunction_sections = 714,              /* -ffunction-sections */
  OPT_fgcse = 715,                           /* -fgcse */
  OPT_fgcse_after_reload = 716,              /* -fgcse-after-reload */
  OPT_fgcse_las = 717,                       /* -fgcse-las */
  OPT_fgcse_lm = 718,                        /* -fgcse-lm */
  OPT_fgcse_sm = 719,                        /* -fgcse-sm */
  OPT_fgimple = 720,                         /* -fgimple */
  OPT_fgnat_encodings_ = 721,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 722,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 723,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 724,                         /* -fgnu-tm */
  OPT_fgnu_unique = 725,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 726,                   /* -fgnu89-inline */
  OPT_fgo_c_header_ = 727,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 728,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 729,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 730,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 731,                /* -fgo-debug-escape */
  OPT_fgo_dump_ = 732,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 733,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 734,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 735,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 736,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 737,                       /* -fgraphite */
  OPT_fgraphite_identity = 738,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 739,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 740, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 741, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 742, */                     /* -fhelp */
  /* OPT_fhelp_ = 743, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 744,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 745, */                /* -fhonor-std */
  OPT_fhosted = 746,                         /* -fhosted */
  /* OPT_fhuge_objects = 747, */             /* -fhuge-objects */
  OPT_fident = 748,                          /* -fident */
  OPT_fif_conversion = 749,                  /* -fif-conversion */
  OPT_fif_conversion2 = 750,                 /* -fif-conversion2 */
  OPT_filelist = 751,                        /* -filelist */
  OPT_fimplement_inlines = 752,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 753,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 754,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 755,             /* -fimplicit-templates */
  OPT_findirect_inlining = 756,              /* -findirect-inlining */
  OPT_findirect_virtual_calls = 757,         /* -findirect-virtual-calls */
  OPT_finhibit_size_directive = 758,         /* -finhibit-size-directive */
  OPT_finit_character_ = 759,                /* -finit-character= */
  OPT_finit_derived = 760,                   /* -finit-derived */
  OPT_finit_integer_ = 761,                  /* -finit-integer= */
  OPT_finit_local_zero = 762,                /* -finit-local-zero */
  OPT_finit_logical_ = 763,                  /* -finit-logical= */
  OPT_finit_real_ = 764,                     /* -finit-real= */
  OPT_finline = 765,                         /* -finline */
  OPT_finline_atomics = 766,                 /* -finline-atomics */
  OPT_finline_functions = 767,               /* -finline-functions */
  OPT_finline_functions_called_once = 768,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 769, */            /* -finline-limit- */
  OPT_finline_limit_ = 770,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 771,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 772,         /* -finline-small-functions */
  OPT_finput_charset_ = 773,                 /* -finput-charset= */
  OPT_finstrument_functions = 774,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 775,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 776,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 777,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 778,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 779,        /* -fintrinsic-modules-path= */
  OPT_fipa_bit_cp = 780,                     /* -fipa-bit-cp */
  OPT_fipa_cp = 781,                         /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 782, */         /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 783,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 784,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 785,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 786,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 787, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 788,                    /* -fipa-profile */
  OPT_fipa_pta = 789,                        /* -fipa-pta */
  OPT_fipa_pure_const = 790,                 /* -fipa-pure-const */
  OPT_fipa_ra = 791,                         /* -fipa-ra */
  OPT_fipa_reference = 792,                  /* -fipa-reference */
  OPT_fipa_sra = 793,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 794, */         /* -fipa-struct-reorg */
  OPT_fipa_vrp = 795,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 796,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 797,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 798,              /* -fira-loop-pressure */
  OPT_fira_region_ = 799,                    /* -fira-region= */
  OPT_fira_share_save_slots = 800,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 801,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 802,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 803,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 804,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 805,               /* -fivar-visibility= */
  OPT_fivopts = 806,                         /* -fivopts */
  OPT_fjump_tables = 807,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 808,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 809,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 810,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 811,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 812,          /* -fkeep-static-functions */
  ...
  OPT_flifetime_dse_ = 818,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 819,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 820,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 821,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 822,                    /* -flocal-ivars */
  /* OPT_floop_block = 823, */               /* -floop-block */
  /* OPT_floop_flatten = 824, */             /* -floop-flatten */
  /* OPT_floop_interchange = 825, */         /* -floop-interchange */
  OPT_floop_nest_optimize = 826,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 827, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 828,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 829, */          /* -floop-strip-mine */
  /* OPT_floop_unroll_and_jam = 830, */      /* -floop-unroll-and-jam */
  OPT_flra_remat = 831,                      /* -flra-remat */
  OPT_flto = 832,                            /* -flto */
  OPT_flto_compression_level_ = 833,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 834,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 835,                 /* -flto-partition= */
  OPT_flto_report = 836,                     /* -flto-report */
  OPT_flto_report_wpa = 837,                 /* -flto-report-wpa */
  OPT_flto_ = 838,                           /* -flto= */
  OPT_fltrans = 839,                         /* -fltrans */
  OPT_fltrans_output_list_ = 840,            /* -fltrans-output-list= */
  OPT_fmath_errno = 841,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 842,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 843,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 844,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 845,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 846,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 847,                     /* -fmem-report */
  OPT_fmem_report_wpa = 848,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 849,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 850,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 851,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 852,                /* -fmessage-length= */
  OPT_fmodule_private = 853,                 /* -fmodule-private */
  OPT_fmodulo_sched = 854,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 855,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 856,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 857,                  /* -fms-extensions */
  /* OPT_fmudflap = 858, */                  /* -fmudflap */
  /* OPT_fmudflapir = 859, */                /* -fmudflapir */
  /* OPT_fmudflapth = 860, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 861, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 862, */                  /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 863,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 864,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 865,                   /* -fnext-runtime */
  OPT_fnil_receivers = 866,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 867,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 868,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 869, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 870,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 871,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 872,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 873,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 874,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 875,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 876,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 877,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 878,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 879,                   /* -foffload-abi= */
  OPT_foffload_ = 880,                       /* -foffload= */
  OPT_fomit_frame_pointer = 881,             /* -fomit-frame-pointer */
  OPT_fopenacc = 882,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 883,                   /* -fopenacc-dim= */
  OPT_fopenmp = 884,                         /* -fopenmp */
  OPT_fopenmp_simd = 885,                    /* -fopenmp-simd */
  OPT_foperator_names = 886,                 /* -foperator-names */
  OPT_fopt_info = 887,                       /* -fopt-info */
  OPT_fopt_info_ = 888,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 889, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 890,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 891,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 892, */           /* -foptional-diags */
  /* OPT_force_cpusubtype_ALL = 893, */      /* -force_cpusubtype_ALL */
  /* OPT_force_flat_namespace = 894, */      /* -force_flat_namespace */
  ...
  OPT_fpcc_struct_return = 899,              /* -fpcc-struct-return */
  OPT_fpch_deps = 900,                       /* -fpch-deps */
  OPT_fpch_preprocess = 901,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 902,                     /* -fpeel-loops */
  OPT_fpeephole = 903,                       /* -fpeephole */
  OPT_fpeephole2 = 904,                      /* -fpeephole2 */
  OPT_fpermissive = 905,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 906,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 907,                            /* -fpic */
  OPT_fpie = 908,                            /* -fpie */
  OPT_fplan9_extensions = 909,               /* -fplan9-extensions */
  OPT_fplt = 910,                            /* -fplt */
  OPT_fplugin_arg_ = 911,                    /* -fplugin-arg- */
  OPT_fplugin_ = 912,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 913,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 914,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 915,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 916,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 917,                   /* -fpreprocessed */
  OPT_fpretty_templates = 918,               /* -fpretty-templates */
  OPT_fprintf_return_value = 919,            /* -fprintf-return-value */
  OPT_fprofile = 920,                        /* -fprofile */
  OPT_fprofile_arcs = 921,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 922,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 923,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 924,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 925,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 926,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 927,                 /* -fprofile-report */
  OPT_fprofile_update_ = 928,                /* -fprofile-update= */
  OPT_fprofile_use = 929,                    /* -fprofile-use */
  OPT_fprofile_use_ = 930,                   /* -fprofile-use= */
  OPT_fprofile_values = 931,                 /* -fprofile-values */
  OPT_fprotect_parens = 932,                 /* -fprotect-parens */
  OPT_framework = 933,                       /* -framework */
  OPT_frandom_seed = 934,                    /* -frandom-seed */
  OPT_frandom_seed_ = 935,                   /* -frandom-seed= */
  OPT_frange_check = 936,                    /* -frange-check */
  OPT_freal_4_real_10 = 937,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 938,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 939,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 940,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 941,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 942,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 943,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 944,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 945,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 946,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 947,                /* -frecord-marker=8 */
  OPT_frecursive = 948,                      /* -frecursive */
  OPT_free = 949,                            /* -free */
  OPT_freg_struct_return = 950,              /* -freg-struct-return */
  /* OPT_fregmove = 951, */                  /* -fregmove */
  OPT_frename_registers = 952,               /* -frename-registers */
  OPT_freorder_blocks = 953,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 954,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 955,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 956,              /* -freorder-functions */
  OPT_frepack_arrays = 957,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 958,           /* -freplace-objc-classes */
  OPT_frepo = 959,                           /* -frepo */
  OPT_freport_bug = 960,                     /* -freport-bug */
  OPT_frequire_return_statement = 961,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 962,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 963, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 964,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 965,                    /* -fresolution= */
  OPT_frounding_math = 966,                  /* -frounding-math */
  OPT_frtti = 967,                           /* -frtti */
  OPT_fsanitize_address_use_after_scope = 968,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_trace_pc = 969,     /* -fsanitize-coverage=trace-pc */
  OPT_fsanitize_recover = 970,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 971,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 972,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 973,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 974,                      /* -fsanitize= */
  OPT_fsched_critical_path_heuristic = 975,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 976,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 977,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 978,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 979,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 980,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 981,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 982,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 983,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 984,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 985,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 986,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 987,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 988,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 989,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 990,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 991,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 992, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 993,                /* -fschedule-fusion */
  OPT_fschedule_insns = 994,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 995,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 996,              /* -fsecond-underscore */
  OPT_fsection_anchors = 997,                /* -fsection-anchors */
  /* OPT_fsee = 998, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 999,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1000,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1001,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1002,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1003,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1004,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1005,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1006,                   /* -fshort-enums */
  OPT_fshort_wchar = 1007,                   /* -fshort-wchar */
  OPT_fshow_column = 1008,                   /* -fshow-column */
  OPT_fshrink_wrap = 1009,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1010,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1011,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1012,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1013,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1014,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1015,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1016,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1017,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1018,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1019,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1020,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1021,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1022,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1023,              /* -fsplit-wide-types */
  /* OPT_fsquangle = 1024, */                /* -fsquangle */
  OPT_fssa_backprop = 1025,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1026,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1027,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1028,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1029, */             /* -fstack-check */
  OPT_fstack_check_ = 1030,                  /* -fstack-check= */
  OPT_fstack_limit = 1031,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1032,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1033,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1034,               /* -fstack-protector */
  OPT_fstack_protector_all = 1035,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1036,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1037,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1038,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1039,                   /* -fstack-usage */
  OPT_fstats = 1040,                         /* -fstats */
  OPT_fstdarg_opt = 1041,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1042,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1043, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1044,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1045,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1046,               /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 1047, */        /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1048,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1049, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1050,            /* -fstrong-eval-order= */
  OPT_fsync_libcalls = 1051,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1052,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1053,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1054, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1055,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1056, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1057,               /* -ftemplate-depth= */
  OPT_fterminated_vtables = 1058,            /* -fterminated-vtables */
  OPT_ftest_coverage = 1059,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1060,              /* -ftest-forall-temp */
  /* OPT_fthis_is_variable = 1061, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1062,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1063,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1064,                   /* -ftime-report */
  OPT_ftime_report_details = 1065,           /* -ftime-report-details */
  OPT_ftls_model_ = 1066,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1067,              /* -ftoplevel-reorder */
  OPT_ftracer = 1068,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1069,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1070,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1071,                   /* -ftrampolines */
  OPT_ftrapping_math = 1072,                 /* -ftrapping-math */
  OPT_ftrapv = 1073,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1074,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1075,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1076,                      /* -ftree-ccp */
  OPT_ftree_ch = 1077,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1078, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1079,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1080,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1081, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1082,                   /* -ftree-cselim */
  OPT_ftree_dce = 1083,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1084,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1085,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1086,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1087,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1088, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1089,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1090,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1091, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1092,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1093,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1094, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1095,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1096,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1097,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1098,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1099,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1100,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1101,                      /* -ftree-pre */
  OPT_ftree_pta = 1102,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1103,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1104, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1105,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1106,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1107,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1108,                     /* -ftree-slsr */
  OPT_ftree_sra = 1109,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1110, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1111, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1112,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1113,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1114,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1115, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1116,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1117, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1118,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1119,         /* -funconstrained-commons */
  OPT_funderscoring = 1120,                  /* -funderscoring */
  OPT_funit_at_a_time = 1121,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1122,              /* -funroll-all-loops */
  OPT_funroll_loops = 1123,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1124, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1125,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1126,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1127,                 /* -funsigned-char */
  OPT_funswitch_loops = 1128,                /* -funswitch-loops */
  OPT_funwind_tables = 1129,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1130,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1131,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1132,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1133,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1134,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1135,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1136,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1137,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1138,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1139,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1140, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1141,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1142,                   /* -fverbose-asm */
  /* OPT_fversion = 1143, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1144,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1145,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1146,                   /* -fvisibility= */
  OPT_fvpt = 1147,                           /* -fvpt */
  /* OPT_fvtable_gc = 1148, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1149, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1150,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1151,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1152,                     /* -fvtv-debug */
  OPT_fweak = 1153,                          /* -fweak */
  OPT_fweb = 1154,                           /* -fweb */
  /* OPT_fwhole_file = 1155, */              /* -fwhole-file */
  OPT_fwhole_program = 1156,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1157,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1158,             /* -fworking-directory */
  OPT_fwpa = 1159,                           /* -fwpa */
  OPT_fwpa_ = 1160,                          /* -fwpa= */
  OPT_fwrapv = 1161,                         /* -fwrapv */
  /* OPT_fxref = 1162, */                    /* -fxref */
  /* OPT_fzee = 1163, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1164,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1165,                     /* -fzero-link */
  OPT_g = 1166,                              /* -g */
  OPT_gant = 1167,                           /* -gant */
  OPT_gcoff = 1168,                          /* -gcoff */
  OPT_gcolumn_info = 1169,                   /* -gcolumn-info */
  OPT_gdwarf = 1170,                         /* -gdwarf */
  OPT_gdwarf_ = 1171,                        /* -gdwarf- */
  OPT_gen_decls = 1172,                      /* -gen-decls */
  OPT_gfull = 1173,                          /* -gfull */
  OPT_ggdb = 1174,                           /* -ggdb */
  OPT_ggnu_pubnames = 1175,                  /* -ggnu-pubnames */
  OPT_gnat = 1176,                           /* -gnat */
  OPT_gnatO = 1177,                          /* -gnatO */
  OPT_gno_column_info = 1178,                /* -gno-column-info */
  OPT_gno_pubnames = 1179,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1180,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1181,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1182,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1183,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1184,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1185,                   /* -gsplit-dwarf */
  OPT_gstabs = 1186,                         /* -gstabs */
  OPT_gstabs_ = 1187,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1188,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1189,                        /* -gtoggle */
  OPT_gused = 1190,                          /* -gused */
  OPT_gvms = 1191,                           /* -gvms */
  OPT_gxcoff = 1192,                         /* -gxcoff */
  OPT_gxcoff_ = 1193,                        /* -gxcoff+ */
  OPT_gz = 1194,                             /* -gz */
  OPT_gz_ = 1195,                            /* -gz= */
  OPT_h = 1196,                              /* -h */
  OPT_headerpad_max_install_names = 1197,    /* -headerpad_max_install_names */
  OPT_idirafter = 1198,                      /* -idirafter */
  OPT_iframework = 1199,                     /* -iframework */
  OPT_imacros = 1200,                        /* -imacros */
  /* OPT_image_base = 1201, */               /* -image_base */
  OPT_imultiarch = 1202,                     /* -imultiarch */
  OPT_imultilib = 1203,                      /* -imultilib */
  OPT_include = 1204,                        /* -include */
  /* OPT_init = 1205, */                     /* -init */
  /* OPT_install_name = 1206, */             /* -install_name */
  OPT_iplugindir_ = 1207,                    /* -iplugindir= */
  OPT_iprefix = 1208,                        /* -iprefix */
  OPT_iquote = 1209,                         /* -iquote */
  OPT_isysroot = 1210,                       /* -isysroot */
  OPT_isystem = 1211,                        /* -isystem */
  OPT_iwithprefix = 1212,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1213,              /* -iwithprefixbefore */
  OPT_k8 = 1214,                             /* -k8 */
  OPT_keep_private_externs = 1215,           /* -keep_private_externs */
  OPT_l = 1216,                              /* -l */
  OPT_lang_asm = 1217,                       /* -lang-asm */
  OPT_m128bit_long_double = 1218,            /* -m128bit-long-double */
  OPT_m16 = 1219,                            /* -m16 */
  OPT_m32 = 1220,                            /* -m32 */
  OPT_m3dnow = 1221,                         /* -m3dnow */
  OPT_m3dnowa = 1222,                        /* -m3dnowa */
  OPT_m64 = 1223,                            /* -m64 */
  OPT_m80387 = 1224,                         /* -m80387 */
  OPT_m8bit_idiv = 1225,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1226,             /* -m96bit-long-double */
  OPT_mabi_ = 1227,                          /* -mabi= */
  OPT_mabm = 1228,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1229,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1230,                 /* -maddress-mode= */
  OPT_madx = 1231,                           /* -madx */
  OPT_maes = 1232,                           /* -maes */
  OPT_malign_data_ = 1233,                   /* -malign-data= */
  OPT_malign_double = 1234,                  /* -malign-double */
  OPT_malign_functions_ = 1235,              /* -malign-functions= */
  OPT_malign_jumps_ = 1236,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1237,                  /* -malign-loops= */
  OPT_malign_stringops = 1238,               /* -malign-stringops */
  OPT_march_ = 1239,                         /* -march= */
  OPT_masm_ = 1240,                          /* -masm= */
  OPT_matt_stubs = 1241,                     /* -matt-stubs */
  OPT_mavx = 1242,                           /* -mavx */
  OPT_mavx2 = 1243,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1244,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1245,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1246,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1247,                  /* -mavx5124vnniw */
  OPT_mavx512bw = 1248,                      /* -mavx512bw */
  OPT_mavx512cd = 1249,                      /* -mavx512cd */
  OPT_mavx512dq = 1250,                      /* -mavx512dq */
  OPT_mavx512er = 1251,                      /* -mavx512er */
  OPT_mavx512f = 1252,                       /* -mavx512f */
  OPT_mavx512ifma = 1253,                    /* -mavx512ifma */
  OPT_mavx512pf = 1254,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1255,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1256,                      /* -mavx512vl */
  OPT_mavx512vpopcntdq = 1257,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1258,                           /* -mbmi */
  OPT_mbmi2 = 1259,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1260,                  /* -mbranch-cost= */
  OPT_mcld = 1261,                           /* -mcld */
  OPT_mclflushopt = 1262,                    /* -mclflushopt */
  OPT_mclwb = 1263,                          /* -mclwb */
  OPT_mclzero = 1264,                        /* -mclzero */
  OPT_mcmodel_ = 1265,                       /* -mcmodel= */
  OPT_mconstant_cfstrings = 1266,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1267, */                    /* -mcpu= */
  OPT_mcrc32 = 1268,                         /* -mcrc32 */
  OPT_mcx16 = 1269,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1270,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1271,            /* -mdump-tune-features */
  OPT_mdynamic_no_pic = 1272,                /* -mdynamic-no-pic */
  OPT_mf16c = 1273,                          /* -mf16c */
  OPT_mfancy_math_387 = 1274,                /* -mfancy-math-387 */
  OPT_mfentry = 1275,                        /* -mfentry */
  OPT_mfix_and_continue = 1276,              /* -mfix-and-continue */
  OPT_mfma = 1277,                           /* -mfma */
  OPT_mfma4 = 1278,                          /* -mfma4 */
  OPT_mforce_drap = 1279,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1280,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1281,                       /* -mfpmath= */
  OPT_mfsgsbase = 1282,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1283,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1284, */              /* -mfused-madd */
  OPT_mfxsr = 1285,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1286,             /* -mgeneral-regs-only */
  OPT_mhard_float = 1287,                    /* -mhard-float */
  OPT_mhle = 1288,                           /* -mhle */
  OPT_miamcu = 1289,                         /* -miamcu */
  OPT_mieee_fp = 1290,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1291,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1292,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1293,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1294,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1295,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1296, */            /* -mintel-syntax */
  OPT_mkernel = 1297,                        /* -mkernel */
  OPT_mlarge_data_threshold_ = 1298,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1299,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1300,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1301,                /* -mlong-double-80 */
  OPT_mlwp = 1302,                           /* -mlwp */
  OPT_mlzcnt = 1303,                         /* -mlzcnt */
  OPT_mmacosx_version_min_ = 1304,           /* -mmacosx-version-min= */
  OPT_mmemcpy_strategy_ = 1305,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1306,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1307,                  /* -mmitigate-rop */
  OPT_mmmx = 1308,                           /* -mmmx */
  OPT_mmovbe = 1309,                         /* -mmovbe */
  OPT_mmpx = 1310,                           /* -mmpx */
  OPT_mms_bitfields = 1311,                  /* -mms-bitfields */
  OPT_mmwaitx = 1312,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1313,            /* -mno-align-stringops */
  OPT_mno_default = 1314,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1315,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1316,                  /* -mno-push-args */
  OPT_mno_red_zone = 1317,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1318,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1319,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1320,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1321,                 /* -mone-byte-bool */
  OPT_mpc32 = 1322,                          /* -mpc32 */
  OPT_mpc64 = 1323,                          /* -mpc64 */
  OPT_mpc80 = 1324,                          /* -mpc80 */
  OPT_mpclmul = 1325,                        /* -mpclmul */
  OPT_mpcommit = 1326,                       /* -mpcommit */
  OPT_mpku = 1327,                           /* -mpku */
  OPT_mpopcnt = 1328,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1329,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1330,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1331,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1332,                        /* -mprfchw */
  OPT_mpush_args = 1333,                     /* -mpush-args */
  OPT_mrdpid = 1334,                         /* -mrdpid */
  OPT_mrdrnd = 1335,                         /* -mrdrnd */
  OPT_mrdseed = 1336,                        /* -mrdseed */
  OPT_mrecip = 1337,                         /* -mrecip */
  OPT_mrecip_ = 1338,                        /* -mrecip= */
  OPT_mrecord_mcount = 1339,                 /* -mrecord-mcount */
  OPT_mred_zone = 1340,                      /* -mred-zone */
  OPT_mregparm_ = 1341,                      /* -mregparm= */
  OPT_mrtd = 1342,                           /* -mrtd */
  OPT_mrtm = 1343,                           /* -mrtm */
  OPT_msahf = 1344,                          /* -msahf */
  OPT_msgx = 1345,                           /* -msgx */
  OPT_msha = 1346,                           /* -msha */
  OPT_mskip_rax_setup = 1347,                /* -mskip-rax-setup */
  OPT_msoft_float = 1348,                    /* -msoft-float */
  OPT_msse = 1349,                           /* -msse */
  OPT_msse2 = 1350,                          /* -msse2 */
  OPT_msse2avx = 1351,                       /* -msse2avx */
  OPT_msse3 = 1352,                          /* -msse3 */
  OPT_msse4 = 1353,                          /* -msse4 */
  OPT_msse4_1 = 1354,                        /* -msse4.1 */
  OPT_msse4_2 = 1355,                        /* -msse4.2 */
  OPT_msse4a = 1356,                         /* -msse4a */
  /* OPT_msse5 = 1357, */                    /* -msse5 */
  OPT_msseregparm = 1358,                    /* -msseregparm */
  OPT_mssse3 = 1359,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1360,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1361,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1362,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1363,            /* -mstringop-strategy= */
  OPT_mstv = 1364,                           /* -mstv */
  OPT_mtarget_linker = 1365,                 /* -mtarget-linker */
  OPT_mtbm = 1366,                           /* -mtbm */
  OPT_mtls_dialect_ = 1367,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1368,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1369,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1370,                         /* -mtune= */
  /* OPT_multi_module = 1371, */             /* -multi_module */
  /* OPT_multiply_defined = 1372, */         /* -multiply_defined */
  /* OPT_multiply_defined_unused = 1373, */  /* -multiply_defined_unused */
  OPT_mveclibabi_ = 1374,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1375,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1376,                    /* -mvzeroupper */
  OPT_mx32 = 1377,                           /* -mx32 */
  OPT_mxop = 1378,                           /* -mxop */
  OPT_mxsave = 1379,                         /* -mxsave */
  OPT_mxsavec = 1380,                        /* -mxsavec */
  OPT_mxsaveopt = 1381,                      /* -mxsaveopt */
  OPT_mxsaves = 1382,                        /* -mxsaves */
  OPT_n = 1383,                              /* -n */
  OPT_no_canonical_prefixes = 1384,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1385,              /* -no-integrated-cpp */
  OPT_no_pie = 1386,                         /* -no-pie */
  /* OPT_no_dead_strip_inits_and_terms = 1387, *//* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1388,                          /* -nocpp */
  OPT_nodefaultlibs = 1389,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 1390,                /* -nofixprebinding */
  OPT_nomultidefs = 1391,                    /* -nomultidefs */
  OPT_noprebind = 1392,                      /* -noprebind */
  OPT_noseglinkedit = 1393,                  /* -noseglinkedit */
  OPT_nostartfiles = 1394,                   /* -nostartfiles */
  OPT_nostdinc = 1395,                       /* -nostdinc */
  OPT_nostdinc__ = 1396,                     /* -nostdinc++ */
  OPT_nostdlib = 1397,                       /* -nostdlib */
  OPT_o = 1398,                              /* -o */
  OPT_object = 1399,                         /* -object */
  OPT_p = 1400,                              /* -p */
  OPT_pagezero_size = 1401,                  /* -pagezero_size */
  OPT_pass_exit_codes = 1402,                /* -pass-exit-codes */
  /* OPT_pedantic = 1403, */                 /* -pedantic */
  OPT_pedantic_errors = 1404,                /* -pedantic-errors */
  OPT_pg = 1405,                             /* -pg */
  OPT_pie = 1406,                            /* -pie */
  OPT_pipe = 1407,                           /* -pipe */
  OPT_prebind = 1408,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 1409,   /* -prebind_all_twolevel_modules */
  OPT_preload = 1410,                        /* -preload */
  OPT_print_file_name_ = 1411,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1412,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1413,          /* -print-multi-directory */
  OPT_print_multi_lib = 1414,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1415,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1416,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1417,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1418,               /* -print-prog-name= */
  OPT_print_search_dirs = 1419,              /* -print-search-dirs */
  OPT_print_sysroot = 1420,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1421,   /* -print-sysroot-headers-suffix */
  OPT_private_bundle = 1422,                 /* -private_bundle */
  OPT_pthread = 1423,                        /* -pthread */
  OPT_quiet = 1424,                          /* -quiet */
  OPT_r = 1425,                              /* -r */
  OPT_rdynamic = 1426,                       /* -rdynamic */
  OPT_read_only_relocs = 1427,               /* -read_only_relocs */
  OPT_remap = 1428,                          /* -remap */
  OPT_s = 1429,                              /* -s */
  OPT_save_temps = 1430,                     /* -save-temps */
  OPT_save_temps_ = 1431,                    /* -save-temps= */
  OPT_sectalign = 1432,                      /* -sectalign */
  OPT_sectcreate = 1433,                     /* -sectcreate */
  OPT_sectobjectsymbols = 1434,              /* -sectobjectsymbols */
  OPT_sectorder = 1435,                      /* -sectorder */
  OPT_seg1addr = 1436,                       /* -seg1addr */
  /* OPT_seg_addr_table = 1437, */           /* -seg_addr_table */
  /* OPT_seg_addr_table_filename = 1438, */  /* -seg_addr_table_filename */
  /* OPT_segaddr = 1439, */                  /* -segaddr */
  OPT_segcreate = 1440,                      /* -segcreate */
  OPT_seglinkedit = 1441,                    /* -seglinkedit */
  OPT_segprot = 1442,                        /* -segprot */
  /* OPT_segs_read_only_addr = 1443, */      /* -segs_read_only_addr */
  /* OPT_segs_read_write_addr = 1444, */     /* -segs_read_write_addr */
  OPT_shared = 1445,                         /* -shared */
  OPT_shared_libgcc = 1446,                  /* -shared-libgcc */
  /* OPT_single_module = 1447, */            /* -single_module */
  /* OPT_specs = 1448, */                    /* -specs */
  OPT_specs_ = 1449,                         /* -specs= */
  OPT_static = 1450,                         /* -static */
  OPT_static_libasan = 1451,                 /* -static-libasan */
  OPT_static_libgcc = 1452,                  /* -static-libgcc */
  OPT_static_libgfortran = 1453,             /* -static-libgfortran */
  OPT_static_libgo = 1454,                   /* -static-libgo */
  OPT_static_liblsan = 1455,                 /* -static-liblsan */
  OPT_static_libmpx = 1456,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1457,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1458,               /* -static-libstdc++ */
  OPT_static_libtsan = 1459,                 /* -static-libtsan */
  OPT_static_libubsan = 1460,                /* -static-libubsan */
  /* OPT_std_c__03 = 1461, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1462, */                /* -std=c++0x */
  OPT_std_c__11 = 1463,                      /* -std=c++11 */
  OPT_std_c__14 = 1464,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1465, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1466, */                /* -std=c++1y */
  OPT_std_c__1z = 1467,                      /* -std=c++1z */
  OPT_std_c__98 = 1468,                      /* -std=c++98 */
  OPT_std_c11 = 1469,                        /* -std=c11 */
  /* OPT_std_c1x = 1470, */                  /* -std=c1x */
  /* OPT_std_c89 = 1471, */                  /* -std=c89 */
  OPT_std_c90 = 1472,                        /* -std=c90 */
  OPT_std_c99 = 1473,                        /* -std=c99 */
  /* OPT_std_c9x = 1474, */                  /* -std=c9x */
  OPT_std_f2003 = 1475,                      /* -std=f2003 */
  OPT_std_f2008 = 1476,                      /* -std=f2008 */
  OPT_std_f2008ts = 1477,                    /* -std=f2008ts */
  OPT_std_f95 = 1478,                        /* -std=f95 */
  OPT_std_gnu = 1479,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1480, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1481, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1482,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1483,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1484, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1485, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1486,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1487,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1488,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1489, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1490, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1491,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1492,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1493, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1494, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1495,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1496, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1497, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1498, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1499,                     /* -std=legacy */
  OPT_sub_library = 1500,                    /* -sub_library */
  OPT_sub_umbrella = 1501,                   /* -sub_umbrella */
  OPT_symbolic = 1502,                       /* -symbolic */
  OPT_t = 1503,                              /* -t */
  OPT_time = 1504,                           /* -time */
  OPT_time_ = 1505,                          /* -time= */
  OPT_traditional = 1506,                    /* -traditional */
  OPT_traditional_cpp = 1507,                /* -traditional-cpp */
  OPT_trigraphs = 1508,                      /* -trigraphs */
  OPT_twolevel_namespace = 1509,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 1510,       /* -twolevel_namespace_hints */
  OPT_u = 1511,                              /* -u */
  /* OPT_umbrella = 1512, */                 /* -umbrella */
  OPT_undef = 1513,                          /* -undef */
  OPT_undefined = 1514,                      /* -undefined */
  /* OPT_unexported_symbols_list = 1515, */  /* -unexported_symbols_list */
  OPT_v = 1516,                              /* -v */
  OPT_version = 1517,                        /* -version */
  OPT_w = 1518,                              /* -w */
  /* OPT_weak_reference_mismatches = 1519, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 1520,                    /* -whatsloaded */
  OPT_whyload = 1521,                        /* -whyload */
  OPT_wrapper = 1522,                        /* -wrapper */
  OPT_x = 1523,                              /* -x */
  OPT_y = 1524,                              /* -y */
  OPT_z = 1525,                              /* -z */
  N_OPTS,
